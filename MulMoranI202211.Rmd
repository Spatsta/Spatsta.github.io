...
```{r}
##数据读取
air_202211 <- read.xlsx("./data/空气质量数据/202211.xlsx")
...
#****************联结地图数据与空气污染时间*******************************
Sichuan_map <- readOGR("./data/四川省地图/SC.shp",use_iconv = TRUE, encoding = "UTF-8")
...
#读取热度数据
data0 <- read.xlsx("./data/空气质量数据/202211oneAQI.xlsx")
...
# # 数据转换
# data_csv <- as.data.table(data)
# data_xlsx <- as.data.frame(data)
# # 将 data.table 保存为 .csv 文件
# fwrite(data_csv, "LLCP2021.csv")
# # 将 data.frame 保存为 .xlsx 文件
# write.xlsx(data_xlsx, file = "LLCP2021.xlsx", row.names = FALSE, sheetName = "Sheet1")
# ```
